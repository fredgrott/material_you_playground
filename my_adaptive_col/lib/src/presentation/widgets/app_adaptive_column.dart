...
//
// Original by Material IO team as poart of
// adaptive components and under BSD-clause-3 licnese.
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints,) {
        final BreakpointSystemEntry _entry = getBreakpointEntry(context);
