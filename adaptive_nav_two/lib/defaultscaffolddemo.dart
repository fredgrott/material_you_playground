  ...
  Widget build(BuildContext context) {
    return AdaptiveNavigationScaffold(
      ...
      appBar: AdaptiveAppBar(
        ...
        // MD3 Navbars have zero elevation as MD3 uses overlays to
        // denote UI role sectional roles even in dark mode. In dark
        // mode the overlays change opacity to influence color hue
        // impresssions.
        elevation: 2,
        // MD3 no shadows for nav bars
        shadowColor: Colors.transparent,
        // dark applies an overlay based on elevation changing the tone so should
        // not need to switch base don ight and dark modes.
        backgroundColor: Color(materialLightSystemScheme.primary).withOpacity(0.4),
      ),
      body: _body(),
