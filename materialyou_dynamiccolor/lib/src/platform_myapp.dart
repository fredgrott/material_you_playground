...
import 'package:materialyou_dynamiccolor/src/infrastrucutre/app_widget_keys.dart';
import 'package:materialyou_dynamiccolor/src/localization_gen/l10n.dart';
import 'package:materialyou_dynamiccolor/src/presentation/features/home/default_scaffold_demo.dart';
import 'package:materialyou_dynamiccolor/src/presentation/themes/app_themedata.dart';
...
class PlatformMyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DynamicColorBuilder(builder: (CorePalette? corePalette) {
      return Theme(
