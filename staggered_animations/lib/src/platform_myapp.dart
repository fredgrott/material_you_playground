...
import 'package:staggered_animations/src/infrastrucutre/app_widget_keys.dart';

import 'package:staggered_animations/src/localization_gen/l10n.dart';

import 'package:staggered_animations/src/presentation/features/home/staggered_animations.dart';
import 'package:staggered_animations/src/presentation/themes/app_themedata.dart';
    ...
    return Theme(
      ...
      child: PlatformProvider(
        ...
        builder: (context) => PlatformApp(
          ...
          home: const StaggeredAnimations(),
        ),
      ),
    );
  }
